...
DEL "%MyDocuments%\Visual Studio 2010\Code Snippets\Visual C#\My Code Snippets\IntroToACS2*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2010\Code Snippets\XML\My Xml Snippets\IntroToACS2*.snippet" 2>NUL
